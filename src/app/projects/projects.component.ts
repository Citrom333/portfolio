...
export class ProjectsComponent {
  ...
  parentProjects = [
    ...
    { description: { title: "Family Organizer for mobile", link1: "", link2: `${this.backendUrl}/download`, about: "I used Capacitor framework by Ionic to make a mobile Native mobile application of my webapp. You can download it by clicking the link." }, image: { src: "../../assets/projectpics/projectimage14.png", alt: 'Image 4' } },
